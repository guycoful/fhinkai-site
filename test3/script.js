/* ============================================================================
   FHINK AI · Opening Questionnaire — Version C (minimal)
============================================================================ */

(function () {
  "use strict";

  const STORAGE_KEY = "fhink:opening-questionnaire-c";
  ...
  function buildRecap() {
    ...
    if (answers.q1) pills.push({ label: "מעקב הוצאות", value: answers.q1 });
    if (answers.q4) pills.push({ label: "ביטחון פיננסי", value: answers.q4 });
